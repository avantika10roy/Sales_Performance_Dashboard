...
class ExploratoryDataAnalysis:
    ...
    def barplot_total_sale_by_column(self, column_name: str = None):
        ...
        return pio.to_html(barplot, full_html = False)
    ...
    def pieplot_for_product_sale(self):
        ...
        return pio.to_html(piechart, full_html = False)
    ...
    def groupedbar_product_over_country(self):
        ...
        grouped_bar = px.bar(self.input_data,
                             ...
                             height                  = 500,
                             width                   = 800)
        return pio.to_html(grouped_bar, full_html = False)
    ...
    def sales_trend_per_product(self):
        ...
        return pio.to_html(linechart, full_html = False)
    ...
    def simple_bubble_plot(self):
        ...
        return pio.to_html(bubble_plot, full_html = False)
    ...
    def heatmap_for_product_profit(self):
        ...
        return pio.to_html(heatmap, full_html = False)
    ...
    def decompose_revenue(self):
        ...
        return pio.to_html(decomposition_plot, full_html = False)
